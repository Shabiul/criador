      ...
      <div className="max-w-3xl mx-auto px-6 py-24">
        ...
        <div className="prose prose-stone max-w-none space-y-8 text-[#4A4540]">
          ...
          <section>
            ...
            <p>Criador Studio is a creative and business consulting agency headquartered in the United Kingdom. We specialise in delivering end-to-end branding, design, and digital solutions to businesses across industries. Our services are governed exclusively by these Terms and any supplementary agreements executed in writing between the parties.</p>
          </section>
