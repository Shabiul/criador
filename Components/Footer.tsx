...
const socials = [
  ...
  {
    label: 'LinkedIn', href: 'https://linkedin.com/criador',
  ...
  {
    label: 'Email', href: 'mailto:hello@criador.co.uk',
      ...
      <div className="max-w-7xl mx-auto relative">
        ...
        <div className="grid md:grid-cols-12 gap-8 md:gap-12 mb-8 md:mb-12">
          ...
          >
            ...
            <div className="space-y-3 pt-2">
              <a href="mailto:hello@criador.co.uk" className="flex items-center gap-3 text-sm text-white/50 hover:text-white transition-colors group">
        ...
        <div className="border-t border-white/8 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-4 text-center sm:text-left">
            <p className="text-white/25 text-sm">© 2026 Criador. All Rights Reserved.</p>
            ...
            <p className="text-white/40 text-sm">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-[#8B31C7] hover:text-[#A040E0] hover:underline font-semibold transition-colors"
              >
                naazailabs.com
              </a>
            </p>
